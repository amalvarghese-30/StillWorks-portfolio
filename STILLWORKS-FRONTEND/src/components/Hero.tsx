      ...
      <div className="container mx-auto px-6 md:px-12 pt-24">
        <div className="max-w-5xl">
          ...
          <motion.p
            ...
            animate={showAnimations ? { opacity: 1, y: 0 } : defaultAnimation}
          ...
          {/* Main heading */}
          <motion.h1
            initial={showAnimations ? { y: "100%" } : false}
            animate={showAnimations ? { y: 0 } : defaultAnimation}
          ...
          {/* Divider line */}
          <motion.div
            initial={showAnimations ? { scaleX: 0 } : false}
            animate={showAnimations ? { scaleX: 1 } : defaultAnimation}
          ...
          <motion.div
            ...
            animate={showAnimations ? { opacity: 1 } : defaultAnimation}
